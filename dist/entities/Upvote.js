...
__decorate([
    ...
    __metadata("design:type", Number)
], Upvote.prototype, "counter", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Wilder_1.default, "upvotes", { onDelete: "CASCADE" }),
    __metadata("design:type", Wilder_1.default)
], Upvote.prototype, "wilder", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Skill_1.default, "upvotes", { onDelete: "CASCADE" }),
